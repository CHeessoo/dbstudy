/*
    기초데이터 준비
    HR 계정의 EMPLOYEES 테이블을 GD계정으로 복사해서 사용
*/
...
-- Hello World 출력하기
BEGIN
    DBMS_OUTPUT.PUT_LINE('Hello World');    -- 오라클은 자바와 다르게 문자와 문자열의 구분이 없다. 문자열도 '' (작은 따옴표) 사용
END;
...
DECLARE
    ...
    MESSAGE     VARCHAR2(6 BYTE);               -- 참조 변수, 스칼라 변수 섞어서 사용도 가능
BEGIN 
