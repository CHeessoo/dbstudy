...
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY, COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID
  FROM EMPLOYEES
 WHERE TO_DATE(HIRE_DATE, 'YY/MM/DD') BETWEEN TO_DATE('2005/01/01', 'YY/MM/DD') AND TO_DATE('2005/12/31', 'YY/MM/DD');
...
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, COMMISSION_PCT * SALARY AS COMMISSIONT
  FROM EMPLOYEES
...
SELECT DEPARTMENT_ID, FLOOR(AVG(SALARY)) AS 부서평균연봉
  FROM EMPLOYEES
...
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, DEPARTMENT_ID
     , RANK() OVER(PARTITION BY DEPARTMENT_ID ORDER BY SALARY DESC) AS 부서내연봉순위  -- PARTITION BY : 분석함수
  FROM EMPLOYEES
