...
CREATE TABLE LECTURE_TBL (
  ...
  , CONSTRAINT FK_ENR_LECT  FOREIGN KEY(EN_NO)   REFERENCES ENROLL_TBL(EN_NO)      ON DELETE SET NULL
);
...
-- 4. 수강신청번호 시퀀스 + 수강신청(ENROLL_TBL) 테이블 데이터 입력
DROP SEQUENCE ENR_SEQ;
CREATE SEQUENCE ENR_SEQ ORDER;

INSERT INTO ENROLL_TBL(EN_NO, STU_NO, COUR_NO, EN_DATE) VALUES(ENR_SEQ.NEXTVAL, 22001, 1, '23/07/03');
INSERT INTO ENROLL_TBL(EN_NO, STU_NO, COUR_NO, EN_DATE) VALUES(ENR_SEQ.NEXTVAL, 22002, 2, '23/07/03');
INSERT INTO ENROLL_TBL(EN_NO, STU_NO, COUR_NO, EN_DATE) VALUES(ENR_SEQ.NEXTVAL, 23001, 3, '23/07/03');



-- 5. 강의번호 시퀀스 + 강의(LECTURE_TBL) 테이블 데이터 입력
DROP SEQUENCE LEC_SEQ;
CREATE SEQUENCE LEC_SEQ ORDER;

INSERT INTO LECTURE_TBL(LEC_NO, PROF_NO, EN_NO, LEC_NAME, LEC_ROOM) VALUES(LEC_SEQ.NEXTVAL, 1, 1, '의로운 도적이 되는 법', 305);
INSERT INTO LECTURE_TBL(LEC_NO, PROF_NO, EN_NO, LEC_NAME, LEC_ROOM) VALUES(LEC_SEQ.NEXTVAL, 2, 2, '핵심의 카운터', 304);
INSERT INTO LECTURE_TBL(LEC_NO, PROF_NO, EN_NO, LEC_NAME, LEC_ROOM) VALUES(LEC_SEQ.NEXTVAL, 3, 3, '마음의 평화 INNER PEACE', 302);
